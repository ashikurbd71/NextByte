            ...
            >
                ...
                <Card className="bg-white/10 backdrop-blur-xl border-white/20 p-3 sm:p-4 lg:p-6 sticky top-20 sm:top-24">
                    ...
                    <Button
                        ...
                        className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-2 sm:py-2 lg:py-3 text-sm sm:text-base lg:text-lg font-semibold mb-3 sm:mb-4"
                    >
                        {paymentLoading ? (
                            <>
                ...
                <Card className="bg-white/10 backdrop-blur-xl border-white/20 p-3 sm:p-4 lg:p-6">
                    ...
                    <div className="space-y-1.5 sm:space-y-2 lg:space-y-3">
                        <div className="flex items-center space-x-2 lg:space-x-3 text-gray-300">
                            ...
                            <span className="text-xs sm:text-sm lg:text-base">+880 1234-567890</span>
                        </div>
                        <div className="flex items-center space-x-2 lg:space-x-3 text-gray-300">
                            <Mail className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-purple-400 flex-shrink-0" />
                            <span className="text-xs sm:text-sm lg:text-base">support@nextbyte.com</span>
                        </div>
                        <div className="flex items-center space-x-2 lg:space-x-3 text-gray-300">
                            <MapPin className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-purple-400 flex-shrink-0" />
                            <span className="text-xs sm:text-sm lg:text-base">Dhaka, Bangladesh</span>
                        </div>
                    </div>
                </Card>
            </motion.div>
