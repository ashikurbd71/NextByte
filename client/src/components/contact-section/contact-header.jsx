        ...
        <section className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto px-2 sm:px-4 leading-relaxed">
                    ...
                    {[
                        {
                            ...
                            contact: "hello@nextbyte.com",
                            href: "mailto:hello@nextbyte.com"
                        },
                        {
