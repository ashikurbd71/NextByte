            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                        Come visit us at our headquarters in San Francisco. We'd love to meet you in person and discuss your learning goals.
                    </p>
                </motion.div>
                        ...
                        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-6 sm:p-8 lg:p-12 h-full min-h-[300px] sm:min-h-[400px] flex items-center justify-center">
                            <div className="text-center text-white">
                                ...
                                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6">
                                    ...
                                    <p className="text-xs sm:text-sm text-white/80">123 Tech Street, Suite 100</p>
                                    <p className="text-xs sm:text-sm text-white/80">San Francisco, CA 94105</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start space-x-3 sm:space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm sm:text-base">123 Tech Street, Suite 100</p>
                                        <p className="text-gray-600 text-sm sm:text-base">San Francisco, CA 94105</p>
                                        <p className="text-gray-600 text-sm sm:text-base">United States</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3 sm:space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm sm:text-base">Monday - Friday: 9:00 AM - 6:00 PM PST</p>
                                        <p className="text-gray-600 text-sm sm:text-base">Saturday: 10:00 AM - 4:00 PM PST</p>
                                ...
                                <div className="flex items-start space-x-3 sm:space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm sm:text-base">Email: hello@nextbyte.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                <div className="flex items-center space-x-2 sm:space-x-3">
                                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                                        <span className="text-blue-600 font-semibold text-xs sm:text-sm">BART</span>
                                    </div>
                                    <div>
                                        <p className="font-medium text-gray-900 text-sm sm:text-base">BART Station</p>
                                        <p className="text-xs sm:text-sm text-gray-600">5-minute walk from Montgomery Station</p>
                                    </div>
                                </div>

                                <div className="flex items-center space-x-2 sm:space-x-3">
                                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-100 rounded-lg flex items-center justify-center">
                                        <span className="text-green-600 font-semibold text-xs sm:text-sm">MUNI</span>
                                    </div>
                                    <div>
                                        <p className="font-medium text-gray-900 text-sm sm:text-base">Muni Metro</p>
                                        <p className="text-xs sm:text-sm text-gray-600">Multiple lines serve our area</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2 sm:space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs sm:text-sm text-gray-600">Street parking and nearby garages available</p>
                                    </div>
                                </div>
                            </div>
