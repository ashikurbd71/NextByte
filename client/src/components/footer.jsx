...
export function Footer() {
    ...
    const socialLinks = [
        { icon: <Facebook className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />, href: "#", label: "Facebook", color: "hover:bg-blue-600" },
    ...
    const contactInfo = [
        { icon: <Mail className="w-3 h-3 sm:w-4 sm:h-4" />, text: "hello@nextbyte.com", href: "mailto:hello@nextbyte.com" },
        { icon: <Phone className="w-3 h-3 sm:w-4 sm:h-4" />, text: "+1 (555) 123-4567", href: "tel:+15551234567" },
        { icon: <MapPin className="w-3 h-3 sm:w-4 sm:h-4" />, text: "San Francisco, CA", href: "#" },
    ]
