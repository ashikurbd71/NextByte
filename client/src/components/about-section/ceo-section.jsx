                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-3 mb-6">
                            {["50K+ Students", "200+ Courses", "Industry Expert"].map((achievement, idx) => (
                                <div
                                    key={idx}
                        ...
                        <div className="flex gap-4">
                            <a href="https://facebook.com/nextbyte" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-full transition-colors duration-300 group">
                            ...
                            <a href="https://instagram.com/nextbyte" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full transition-colors duration-300 group">
