        ...
        <section className="relative py-24 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-8 sm:mb-12 md:mb-16">
                    ...
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white/80 max-w-2xl sm:max-w-3xl md:max-w-4xl mx-auto px-2 sm:px-4 leading-relaxed">
